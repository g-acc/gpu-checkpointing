...
OUTPUT_DIR = Path("results/single_gpu/rr_one_big_many_small/100s_quanta")
...
if __name__ == "__main__":
    round_robin_equal_time_scheduler = wq.Scheduler(get_next_job_fn=lambda _: 0, get_working_time_fn=lambda _: 75)
